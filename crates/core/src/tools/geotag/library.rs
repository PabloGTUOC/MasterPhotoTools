...
mod tests {
    ...
    const MONDAY: [(&str, f64, f64); 3] = [
        ("2026-09-02T19:40:44Z", 52.509998, 3.410099),
        ("2026-09-02T19:45:50Z", 52.516569, 3.427291),
        ("2026-09-02T19:50:56Z", 52.517415, 3.446016),
    ];
    ...
    fn a_second_export_overlapping_the_first_contributes_only_what_is_new() {
        ...
        longer.push(("2026-09-02T19:55:57Z", 52.525582, 3.456232));
    ...
    fn a_fix_that_moved_by_a_hand_span_is_the_same_fix() {
        ...
        let rounded = [
            ("2026-09-02T19:40:44Z", 52.5099981, 3.4100989),
            ("2026-09-02T19:45:50Z", 52.516569, 3.427291),
            ("2026-09-02T19:50:56Z", 52.517415, 3.446016),
        ];
    ...
    fn a_fix_that_moved_a_street_away_is_a_disagreement_with_a_distance_on_it() {
        ...
        let moved = [
            ("2026-09-02T19:40:44Z", 52.509998, 3.410099),
            ("2026-09-02T19:45:50Z", 52.517569, 3.427291), // 111 m north
            ("2026-09-02T19:50:56Z", 52.517415, 3.446016),
        ];
    ...
    fn keeping_what_the_library_holds_leaves_the_timeline_alone_and_still_records_the_dispute() {
        ...
        let moved = file(
            "moved.gpx",
            &[("2026-09-02T19:45:50Z", 52.517569, 3.427291)],
        );
    ...
    fn one_instant_can_be_decided_against_the_default() {
        ...
        let moved = file(
            "moved.gpx",
            &[
                ("2026-09-02T19:40:44Z", 52.519998, 3.410099),
                ("2026-09-02T19:45:50Z", 52.517569, 3.427291),
            ],
        );
        let result = commit_import(
